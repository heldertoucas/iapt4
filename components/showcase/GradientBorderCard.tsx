...
const GradientBorderCard = () => {
    return (
        <div className="bg-pcd-card-bg p-px rounded-2xl shadow-lg border border-gray-200 group relative hover:shadow-xl transition-shadow duration-300">
            {/* Gradient Border */}
            <div className="absolute top-0 left-0 bottom-0 w-1.5 bg-gradient-to-b from-pink-500 to-orange-500 rounded-l-2xl"></div>
            <div className="p-6 pl-10">
                 <div className="w-16 h-16 flex items-center justify-center rounded-lg bg-gradient-to-br from-pink-500 to-orange-500 text-white">
