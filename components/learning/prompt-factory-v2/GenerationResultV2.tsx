...
const GenerationResultV2 = ({ recipe, finalPrompt, generatedOutput, isLoading, onRate, onGenerationSuccess, onReset }: GenerationResultProps) => {
...
export default GenerationResultV2;