    ...
    return (
        <div>
            ...
            <div className="mt-6 p-4 bg-pcd-bg-soft rounded-lg border border-pcd-border">
                ...
                <p className="text-sm text-pcd-text-light mb-4">A sua missão é explorar a "Fábrica de Prompts", copiar uma das sugestões e ter a sua primeira conversa livre com o Gemini.</p>
