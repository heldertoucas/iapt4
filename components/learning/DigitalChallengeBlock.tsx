...
const DigitalChallengeBlock = () => {
    return (
        <div>
            ...
            <div className="mt-6 p-4 bg-pcd-bg-soft rounded-lg border border-pcd-border">
                ...
                <p className="text-sm text-pcd-text-light">Participe numa atividade colaborativa para descobrir o processo da IA, palavra por palavra, votando na mais provável a cada passo.</p>
            </div>
            ...
            <div className="mt-4 p-4 bg-pcd-bg-soft rounded-lg border border-pcd-border">
                ...
                <p className="text-sm text-pcd-text-light mb-4">Sinta na pele como a IA "pensa". Construa uma frase, clicando na palavra que lhe parece mais provável a cada passo.</p>
                <SentenceBuilder />
            </div>
            ...
            <div className="bg-pcd-accent-light border-l-4 border-pcd-accent p-4 rounded-md mt-6">
                ...
                <p className="text-pcd-text-dark">A IA generativa não sabe o que vai dizer. Ela olha para o contexto e "calcula" a palavra seguinte mais provável.</p>
            </div>
        </div>
    );
};
